...
import { Title, Regular, RegularWithMargin } from '../typography'
    ...
    <AboutMe>
      <Description>
        <RegularWithMargin>
          ...
          <br />
          <br />
          <strong>Buddies</strong> is a unique, location based, one-on-one,
          mobile application that allows users to interact with each other and
          ...
          <FI>
            <div style={{ paddingRight: '20px' }}>
              I am also excited to announce that I have been offered a
              Fellowship by Founders Institute Berlin for the Spring Batch of
              2021.
            </div>
            <Img src='assets/The_Founder_Institute_Logo.png' />
          </FI>
          <br /> <hr />
        </RegularWithMargin>
        <br />
